export default {
  ...
  'menu.appList': 'App列表',
  'menu.appWolf': '天天狼人杀',
  'menu.appWolf.playerTreasure': '玩家资产',
  'menu.appWolf.playerTreasure.all': '全部资产',
  'menu.appWolf.playerTreasure.bag': '背包资产',
  'menu.appWolf.playerTreasure.record': '资产详情',
  'menu.appWolf.operation': '操作流水',
  'menu.appWolf.operation.treasure': '操作资产流水',
  'menu.appWolf.operation.status': '操作状态流水',
  'menu.appWolf.operation.avatarframe': '操作头像流水',
  'menu.appWolf.operation.achieve': '操作成就流水',
  'menu.appWolf.playerStatus': '玩家状态',
  'menu.appWolf.playerStatus.queryStatus': '状态查询',
  'menu.appWolf.playerStatus.updateStatus': '状态操作',
  'menu.appWolf.appManager': '应用管理',
  'menu.appWolf.appManager.advertising': '广告位',
  'menu.appWolf.appManager.avatarframe': '头像框',
  'menu.appWolf.appManager.achievement': '成就',
  'menu.appLiao': '了了',
  'menu.appLiao.drawings': '提现',
